...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "240is-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "240is-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "240is-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "240is-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "240is-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "240is-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "240is-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "240is-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "240is-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "240is-irish-cream.jpg";
} else { 
 $img_file = "240is-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/240is/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 240IS Inshore V-Hull<br />
...
<font size="4"><br /></font>
	...
	<tr>
  <td width="44%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">LENGTH: <strong>24' | 7.3m</strong><br />
  BEAM: <strong>8'6" | 2.6m</strong><br />
  DRAFT: <strong>13" | 33cm</strong><br />
  MAX POWER: <strong>350hp | 260kw</strong></font></td>
  <td width="56%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">WEIGHT: <strong>2700lbs | 1225kg</strong><br />
  FUEL CAPACITY: <strong>70gal | 264L</strong><br />
  COCKPIT AREA: <strong>79sq.ft. | 7.34m2</strong><br />
...
<td width="48%" valign="top">
  ...
  <tr>
     <td><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">
      ...
      <?php if (!empty($starboard_box)) {echo $starboard_box . '<br />';} ?>
  ...
  <tr>
	...
	<tr>
      ...
      <?php if (!empty($trolling_motor)) {echo $trolling_motor . '<br />';} ?>
...
Fire Extinguishers (2)</font></td>
  ...
  <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">Console Mounted Porta-Potti<br />
...
Folding Aluminum Console Mounted Footrest<br />
...
Port Forward Rod Boxes<br />
35 Gallon Aft Center Baitwell<br />
Port Aft Insulated Fishbox</font></td>
    </tr>
