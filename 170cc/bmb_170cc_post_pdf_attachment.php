...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "170cc-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "170cc-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "170cc-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "170cc-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "170cc-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "170cc-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "170cc-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "170cc-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "170cc-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "170cc-irish-cream.jpg";
} else { 
 $img_file = "170cc-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/170cc/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 170cc DEEP-V CENTER CONSOLE<br />
...
<font size="4"><br /></font>
	...
	<tr>
  <td width="44%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">LENGTH: <strong>16'10" | 4.8m</strong><br />
  BEAM: <strong>7'3" | 2.2m</strong><br />
  DRAFT: <strong>12" | 30.5cm</strong><br />
  MAX POWER: <strong>115hp | 86kw</strong></font></td>
  <td width="56%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">WEIGHT: <strong>1700lbs | 771kg</strong><br />
  FUEL CAPACITY: <strong>30gal | 98L</strong><br />
  COCKPIT AREA: <strong>21" | 53.3cm</strong><br />
  TRANSFORM HEIGHT: <strong>Single-20"</strong></font></td>
    </tr>
   </table>
 </td> 
</tr>
...
<td width="48%" valign="top">
  ...
  <tr>
  <!-- BATTERY -->
    <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#004E8E" size="14">BATTERY</font></strong></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">
      <?php echo $battery; ?>
  ...
  <tr>
	...
	<tr>
      ...
      <?php if (!empty($baitwell)) {echo $baitwell . '<br />';} ?>
      <?php echo $ski_pylon; ?>
    </font></td>
	</tr>
    </table>  
...
Cockpit Drink Holders, Forward (2), Aft (2)<br />
Waterproof electrical connectors & Tin Plated Copper Wiring<br />
Swim Platform with Folding Stainless Steel Ladder<br />
...
Ritchie Compass<br />
Welded 316L Stainless Steel Console Grab Rail</font></td>
  </tr>
...
Console Switch Panel with waterproof switches, circuit breakers & 12V Outlet<br />
Waterproof Electrical Connectors & Tin-Plated Copper Wiring<br />
Console Interior Light</font></td>
  </tr>
...
Custom Convertible Fiberglass Helm Seat/Leaning Post w/ Storage<br />
54 Qt. Console Cooler Seat w/ Cushion & Backrest<br />
Transom Quarter Seats w/ Cushions & Backrests (2) w/ Storage<br />
Transom Jump Seat Storage Compartments<br />
Bow Locker</font></td>
    </tr>
  </table>
  </td>
