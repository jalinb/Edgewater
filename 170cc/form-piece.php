...
if(isset($_POST['Battery'])){
	ff_setValue('battery', $_POST['Battery']);
}
...
if(isset($_POST['Baitwell'])){
	ff_setValue('baitwell', $_POST['Baitwell']);
}
...
if(isset($_POST['Console_Rail'])){
	ff_setValue('console_rail', $_POST['Console_Rail']);
}
if(isset($_POST['Top'])){
