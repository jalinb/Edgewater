...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "158cs-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "158cs-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "158cs-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "158cs-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "158cs-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "158cs-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "158cs-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "158cs-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "158cs-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "158cs-irish-cream.jpg";
} else { 
 $img_file = "158cs-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/158cs/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 158CS DUAL CONSOLE<br />
...
<td width="48%" valign="top">
  ...
  <tr>
     <td><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">
      <?php if (!empty($backrest_rodholders)) {echo $backrest_rodholders . '<br />';} ?>
...
<tr><td><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></td></tr>
</table>
</td>
...
<td width="48%" valign="top">
  ...
  <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">Stainless Steel Bow and Stern Lifting Rings (3)<br />
  8" Stainless Steel Cleats (4)<br />
  Folding Stainless Steel Transom Boarding Ladder w/ Grab Handle<br />
  Portable 6 Gallon Fuel Tanks (2)<br />
  Fire Extinguisher</font></td>
  </tr>
  ...
  Ritchie Compass<br />
  Stainless Steel Console Grab Handles (2)<br />
  ...
  Helm Fiberglass Bench Seat w/ Removable Cushions<br />
  48 Qt. Console Cooler Seat w/ Cushion<br />
  Bow Storage Locker w/ Drain<br />
  Transom Quarter Storage Compartments (2)</font></td>
    </tr>
  </table>
  </td>
</tr>
