...
if(isset($_POST['Barrier_Coat'])){
	ff_setValue('barrier_coat', $_POST['Barrier_Coat']);
}
...
if(isset($_POST['Steering_Wheel'])){
	ff_setValue('steering_wheel', $_POST['Steering_Wheel']);
}
if(isset($_POST['Seating'])){
	ff_setValue('seating', $_POST['Seating']);
}
if(isset($_POST['Port_Seat'])){
	ff_setValue('port_seat', $_POST['Port_Seat']);
}
if(isset($_POST['Cleats'])){
	ff_setValue('cleats', $_POST['Cleats']);
}
if(isset($_POST['Head'])){
	ff_setValue('head', $_POST['Head']);
}
...
if(isset($_POST['Cockpit_Cover'])){
	ff_setValue('cockpit_cover', $_POST['Cockpit_Cover']);
}
