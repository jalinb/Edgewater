...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "262cc-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "262cc-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "262cc-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "262cc-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "262cc-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "262cc-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "262cc-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "262cc-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "262cc-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "262cc-irish-cream.jpg";
} else { 
 $img_file = "262cc-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/262cc/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 262CC DEEP-V CENTER CONSOLE<br />
...
<font size="4"><br /></font>
	...
	FUEL CAPACITY: <strong>385gal | 1457.38L</strong><br />
...
<td width="48%" valign="top">
  ...
  <tr>
	...
	<tr>
      ...
      <?php if (!empty($ski_pylon)) {echo $ski_pylon . '<br />';} ?>
      <?php if (!empty($pfd_storage)) {echo $pfd_storage . '<br />';} ?>
...
<tr><td><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></td></tr>
</table>
</td>
...
White Powdercoated Fiberglass Hardtop w/ Rod Holders (6), LED Spreader Lights (2), Helm Light, Instrument Box &amp; PFD Storage Bag<br />
...
Switch Panel w/ Waterproof Switches, Circuit Breakers &amp; 12V Outlet<br />
Ritchie Compass<br />
Interior Console Fresh Water Sink w/ Pull-out Shower<br />
Electric Fresh Water Head w/ Holding Tank (7), Overboard Discharge &amp; Pumpout<br />
Interior Console Storage Center w/ Drawers<br />
Stainless Steel Cockpit Toe Rail<br />
Raw Water Washdown Outlet<br />
Stainless Steel Drink Holders on Console (2)<br />
Fresh Water System w/ 19 Gallon Tank</font></td>
	</tr>
...
Underwater LED Lights (2)<br />
1250 GPH Auto/Manual Bilge Pump Aft<br />
...
Fiberglass Leaning Post w/ Premium Cooler, Premium Fiberglass Back Flip Bolster Adjustable Seats w/ Armrests, Stainless Steel Sink, Cutting Board &amp; Storage Box<br />
Forward Console Seat w/ Backrest<br />
Folding Stern Seat<br />
Console Tip-Out Storage Bin<br />
Insulated 120QT In-Floor Fishboxes w/ Pumpout (2)<br />
28 Gallon Transom Baitwell<br />
Under Gunwale Storage<br />
Insulated Bow Storage Locker/Cooler<br />
Insulated Bow Storage/Fishbox w/ Overboard Drain<br />
Line/Fender Gunwale Storage Boxes Port &amp; Starboard<br />
Integrated Forward Seating Backrests with Cup Holders and Storage<br />
Forward Lockable Rod Storage</font></td>
    </tr>
...
Electric Anchor Windlass w/ 200' Rode-15' Chain<br />
