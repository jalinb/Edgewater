...
$doc = JFactory::getDocument();
$BoatEventsParams = modBoatEvents::getData2($params);
$doc->addStyleSheet(JURI::base(true) . 'modules/mod_boatevents/tmpl/style.css', 'text/css' );
require( JModuleHelper::getLayoutPath( 'mod_boatevents' ) );
