...
$show_category = $BoatEventsParams['show_category'];



//Get the Article Category View All Text from the Module

$category_title = $BoatEventsParams['category_title'];



//Get the Article IDs from the Module

$article_id_1 = $BoatEventsParams['article_id_1'];

$article_id_2 = $BoatEventsParams['article_id_2'];



//Get the Article Titles from the Module

$title_1 = $BoatEventsParams['title_1'];

$title_2 = $BoatEventsParams['title_2'];



//Get the Show Months from the Module

$month_1 = $BoatEventsParams['month_1'];

$month_2 = $BoatEventsParams['month_2'];



//Get the Show Years from the Module

$year_1 = $BoatEventsParams['year_1'];

$year_2 = $BoatEventsParams['year_2'];



//Get the Show Start Dates from the Module

$date_1 = $BoatEventsParams['date_1'];

$date_2 = $BoatEventsParams['date_2'];



//Get the Show Excerpts from the Module

$article_excerpt_1 = $BoatEventsParams['article_excerpt_1'];

$article_excerpt_2 = $BoatEventsParams['article_excerpt_2'];
...
<?php
  ...
  echo '<h3 class="show-title">' . '<a class="show-title" href="' . $url_base. 'events-list/'. $article_id_1 . '">' . $title_1 .'</a></h3>';
...
echo '<a class="shows news-btn" href="' . $url_base. 'events-list/'. $article_id_1 . '">More</a>';
...
<?php
  ...
  echo '<h3 class="show-title">' . '<a class="show-title" href="' . $url_base. 'events-list/'. $article_id_2 . '">' . $title_2 .'</a></h3>';
...
echo '<a class="shows news-btn" href="' . $url_base. 'events-list/'. $article_id_2 . '">More</a>';
