...
$message = 'The following person has completed the build my boat for the 262CX, below is a link to a printable PDF with their boat details.' . "\r\n" . "\r\n" . 'Inside Edge Quote: ' . $insideEdgeLink . "\r\n" . "\r\n" . 'Name: ' . $first_name . ', ' . $last_name . "\r\n" . 'Email: ' . $email . "\r\n" . 'Phone: ' . $phone . "\r\n" . "\r\n" . 'Address:' . "\r\n" . $address . $apartment . "\r\n" . $city . ', ' . $state . ' ' . $post_code . "\r\n" . $country . "\r\n" . "\r\n" . 'In what geographic area do you do your boating? ' . $area . "\r\n" . "\r\n" . 'How did you find out about us? ' . $referred_by . "\r\n" . "\r\n" . 'Comments: ' . $comments . "\r\n" . "\r\n" . 'Additional requests: ' . $catalog . "\r\n" . "\r\n" . 'Click this link to view the PDF: ' . $pdfurl; 
		
//Dealer Email Notification
$from = 'info@ewboats.com';
$fromname = 'EdgeWater Boats';
$subject = 'EdgeWater Boat - 262CX Dual Console';
$this->sendMail($from, $fromname, $recipients, $subject, $message);

//Send order info to Xtern with order ID and dealer ID
echo
