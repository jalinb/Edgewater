...
if(isset($_POST['Folding_Seating'])){
	ff_setValue('folding_seating', $_POST['Folding_Seating']);
}
if(isset($_POST['T-Top_Rod_Holders'])){
	ff_setValue('t_top_rod_holders', $_POST['T-Top_Rod_Holders']);
}
...
if(isset($_POST['Aft_Curtain'])){
	ff_setValue('aft_curtain', $_POST['Aft_Curtain']);
}
if(isset($_POST['Prep_Station'])){
	ff_setValue('prep_station', $_POST['Prep_Station']);
}
if(isset($_POST['Cleats'])){
	ff_setValue('cleats', $_POST['Cleats']);
}
...
if(isset($_POST['Bow_Cover'])){
	ff_setValue('bow_cover', $_POST['Bow_Cover']);
}
if(isset($_POST['Transom_Rod_Holders'])){
	ff_setValue('transom_rod_holders', $_POST['Transom_Rod_Holders']);
}
if(isset($_POST['Ski_Pylon'])){
	ff_setValue('ski_pylon', $_POST['Ski_Pylon']);
}
...
if(isset($_POST['transducer_3'])){
	ff_setValue('transducers_3', $_POST['transducer_3']);
}
if(isset($_POST['transducer_4'])){
	ff_setValue('transducers_4', $_POST['transducer_4']);
}
