...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "318cc-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "318cc-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "318cc-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "318cc-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "318cc-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "318cc-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "318cc-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "318cc-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "318cc-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "318cc-irish-cream.jpg";
} else { 
 $img_file = "318cc-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/318cc/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 318CC DEEP-V CENTER CONSOLE<br />
...
<td width="48%" valign="top">
  ...
  Seastar® Tournament Series Hydraulic Steering Cylinder (1)<br />
  ...
  54QT Removable Cooler Under Forward Console Seat<br />
  ...
  Lenco® Dual Ram Recessed Electric Trim Tabs w/ Indicators<br />
  Console Switch Panels w/ Waterproof Switches & 12V Outlet<br />
  Console Interior Main Distribution Panel w/ Battery Switches (3), Circuit Breakers & Electronics Fuse Holders<br />
  ...
  Battery Charger (3 Bank) w/ Shore Power Inlet, Circuit Breaker & Cord<br />
