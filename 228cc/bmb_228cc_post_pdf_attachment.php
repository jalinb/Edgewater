...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "228cc-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "228cc-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "228cc-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "228cc-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "228cc-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "228cc-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "228cc-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "228cc-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "228cc-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "228cc-irish-cream.jpg";
} else { 
 $img_file = "228cc-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/228cc/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 228CC DEEP-V CENTER CONSOLE<br />
...
<font size="4"><br /></font>
  ...
  <td width="56%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">WEIGHT: <strong>3000lbs | 1361kg</strong><br />
  FUEL CAPACITY: <strong>120gal | 454L</strong><br />
  COCKPIT AREA: <strong>84sq.ft. | 7.8m2</strong><br />
...
Swim Platform with Folding Ladder<br />
...
Fresh Water Shower w/ 19 Gallon Tank<br />
Walk-in Console w/ Fiberglass Liner</font></td>
  </tr>
...
Insulated Bow Storage/Fishbox (2) w/ Overboard Drain<br />
28 Gallon Transom Baitwell</font></td>
    </tr>
...
Stainless Steel Anchor Roller w/ Hawse Pipe & Anchor Hook</font></td>
    </tr>
  </table>
  </td>
</tr>
