...
if (stripos($color, "cabernet") !== false) { 
 $img_file = "208cc-cabernet.jpg"; 
} elseif (stripos($color, "fighting") !== false) { 
 $img_file = "208cc-fighting-lady-yellow.jpg"; 
} elseif (stripos($color, "ice") !== false) { 
 $img_file = "208cc-ice-blue.jpg"; 
} elseif (stripos($color, "midnight") !== false) { 
 $img_file = "208cc-midnight-blue.jpg";
} elseif (stripos($color, "olive") !== false) { 
 $img_file = "208cc-olive-green.jpg";
} elseif (stripos($color, "pewter") !== false) { 
 $img_file = "208cc-pewter.jpg";
} elseif (stripos($color, "seafoam") !== false) { 
 $img_file = "208cc-sea-foam-green.jpg";
} elseif (stripos($color, "barth") !== false) { 
 $img_file = "208cc-st-barths-blue.jpg";
} elseif (stripos($color, "stars") !== false) { 
 $img_file = "208cc-stars-stripes-blue.jpg";
} elseif (stripos($color, "irish") !== false) { 
 $img_file = "208cc-irish-cream.jpg";
} else { 
 $img_file = "208cc-standard-white.jpg"; 
}
...
<!-- "img_file" REPLACES BOAT IMAGE DEPENDING ON "color" title -->
  <td><img src="images/208cc/pdf/<?php echo $img_file; ?>" width="450px" height="266px"/></td>
</tr>
<tr>
  <td><strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="14">MY EDGEWATER 208CC DEEP-V CENTER CONSOLE<br />
...
<font size="4"><br /></font>
	...
	<tr>
  <td width="44%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="9">LENGTH: <strong>22'6" | 6.85m</strong><br />
  ...
  FUEL CAPACITY: <strong>87gal | 329L</strong><br />
  COCKPIT AREA: <strong>69sq.ft. | 6.4m2</strong><br />
...
High Density Composite Transom</font></td>
  ...
  <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">Welded Stainless 316L Steel Console Grab Rail<br />
8" Stainless Steel Cleats (6)<br />
...
Stainless Steel Drink Holders on Bow Platform (2)<br />
...
Walk-in Console (5'2" head-room)<br />
Console Mounted Porta-Potti<br />
...
Fresh Water Shower w/ 6 Gallon Tank</font></td>
  </tr>
...
Folding Aluminum Seat on Front of Console w/Backrest<br />
Stainless Steel Folding/Removable Stern Seat w/ Backrest<br />
20 Gallon Transom Baitwell<br />
Insulated Bow Storage/Fishbox w/ Overboard Drain<br />
Stainless Steel Gunwale Mounted Rod Holders (4)<br />
Under Gunwale Rod Racks</font></td>
    </tr>
  ...
  <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="10">Stainless Steel Anchor Roller w/ Hawse Pipe & Anchor Hook<br />
Box Bow Anchor Locker with Overboard Drain</font></td>
    </tr>
  </table>
  </td>
</tr>
