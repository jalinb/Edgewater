...
if(isset($_POST['Bait_Freezer'])){
	ff_setValue('bait_freezer', $_POST['Bait_Freezer']);
}
if(isset($_POST['Cockpit_Stereo'])){
	ff_setValue('cockpit_stereo', $_POST['Cockpit_Stereo']);
}
if(isset($_POST['Folding_Seating'])){
	ff_setValue('folding_seat', $_POST['Folding_Seating']);
}
if(isset($_POST['Jump_Seat'])){
	ff_setValue('jump_seat', $_POST['Jump_Seat']);
}
if(isset($_POST['Top'])){
